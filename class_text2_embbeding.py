...
fname='/home/marta/marta/projInter/database1/outlier'
data1,Yn1=readFile(fname,0)
Yn1=np.array(Yn1, dtype=np.int64)

fname='/home/marta/marta/projInter/database1/normal'
...
#X_train_index=np.asarray(tokenizer.texts_to_sequences(X_train1))
#X_test_index=np.asarray(tokenizer.texts_to_sequences(X_test1))
...
#x_train = tokenizer.sequences_to_matrix(X_train_index, mode='binary')
#x_test = tokenizer.sequences_to_matrix(X_test_index, mode='binary')
