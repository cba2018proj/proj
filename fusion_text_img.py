...
def Metrics(lst_ground_truth,lst_pred):
    ...
    return Precision,Recall,fpr_final
...
Precision_img,Recall_img,fpr_final_img=Metrics(img_ground_truth,img_pred_class)

Precision_txt,Recall_txt,fpr_final_txt=Metrics(txt_ground_truth,txt_pred_class)
...
Precision,Recall,fpr_final=Metrics(txt_ground_truth,final_class)
